...
class TestRecordError:
    ...
    def test_returns_user_message(self):
        with patch("negentropy.perceives.tools._registry.metrics_collector") as mock_metrics:
            msg = record_error(
    ...
    def test_logs_error(self):
        ...
        with patch("negentropy.perceives.tools._registry.metrics_collector"):
            with patch("negentropy.perceives.tools._registry.logger") as mock_logger:
                record_error(
