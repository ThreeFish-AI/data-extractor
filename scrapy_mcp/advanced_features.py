    ...
    async def _extract_data_selenium(self, extract_config: Optional[Dict]) -> Dict[str, Any]:
        ...
        if extract_config:
                    ...
                    if isinstance(config, str):
                        ...
                        if multiple:
                            ...
                            if attr == "text":
                                ...
                                extracted = [elem.get_attribute("outerHTML") for elem in elements]
                        else:
                            try:
            ...
            result["content"]["links"] = [
                {"url": urljoin(self.driver.current_url, a.get("href", "")), "text": a.get_text(strip=True)}
...
class FormHandler:
    ...
    def __init__(self, driver_or_page):
        ...
        self.is_playwright = hasattr(driver_or_page, 'fill')  # Simple check for Playwright page
    ...
    async def _submit_form_selenium(self, submit_button_selector: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            if submit_button_selector:
                ...
                submit_button = self.driver_or_page.find_element(By.CSS_SELECTOR, submit_button_selector)
                submit_button.click()
            else:
                ...
                for selector in submit_selectors:
                    try:
                        if "contains" in selector:
                            ...
                            submit_button = self.driver_or_page.find_element(By.XPATH, xpath)
                        else:
                            submit_button = self.driver_or_page.find_element(By.CSS_SELECTOR, selector)
