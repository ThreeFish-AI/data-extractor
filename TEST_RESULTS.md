...
| ------------ | ------- | ------- | ----- | ----- | --------- |
| **单元测试** | 167     | 165     | 0     | 2     | 98.8%     |
| **集成测试** | 26      | 25      | 0     | 1     | 96.2%     |
| **总计**     | **193** | **190** | **0** | **3** | **98.4%** |

### ✅ 详细测试结果

#### 🔧 单元测试详情 (167 个测试，165 个通过，2 个跳过)
...
- `test_pdf_processor.py`: 25 个测试 (23 个通过，2 个跳过) - PDF 文本提取、Markdown 转换、批量处理、双引擎支持

#### 🔗 集成测试详情 (26 个测试，25 个通过，1 个跳过)
